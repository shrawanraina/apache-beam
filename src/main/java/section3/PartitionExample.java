...
public class PartitionExample {
  ...
  public static void main(String[] args) {
    ...
    PCollection<String> userPColl =
        pipeline.apply(TextIO.read().from(Constants.BASE_PATH + "data/users.csv"));
    ...
    losAngelesList.apply(
        TextIO.write()
            .to(Constants.BASE_PATH + "section3/output-los-angeles")
            .withNumShards(1)
            .withSuffix(Constants.SUFFIX_CSV));
    phoenixList.apply(
        TextIO.write()
            .to(Constants.BASE_PATH + "section3/output-phoenix")
            .withNumShards(1)
            .withSuffix(Constants.SUFFIX_CSV));
    austinList.apply(
        TextIO.write()
            .to(Constants.BASE_PATH + "section3/output-austin")
            .withNumShards(1)
            .withSuffix(Constants.SUFFIX_CSV));
    pipeline.run();
  }
