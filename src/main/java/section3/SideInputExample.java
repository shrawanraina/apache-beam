...
public class SideInputExample {
  ...
  public static void main(String[] args) {
    ...
    PCollection<String> addressPColl = p.apply(
        TextIO.read().from(Constants.BASE_PATH + "common/email.csv"));
    PCollection<KV<String, String>> addressMap = addressPColl.apply(
    ...
    PCollection<String> usersMissingAddress = userPColl.apply(
    ...
    usersMissingAddress.apply(
        TextIO.write().to(Constants.BASE_PATH + "section3/output-side-input")
