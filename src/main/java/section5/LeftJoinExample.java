...
public class LeftJoinExample {
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String, CoGbkResult>> result = KeyedPCollectionTuple.of("Orders", orderKV)
        .and("Users", userKV)
    ...
    output.apply(
        TextIO.write().to(Constants.BASE_PATH + "section5/output-left-join").withNumShards(1)
