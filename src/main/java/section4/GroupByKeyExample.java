...
public class GroupByKeyExample {
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String, Integer>> orderKV =
        orderPColl.apply(
            ParDo.of(
    ...
    PCollection<KV<String, Iterable<Integer>>> orderKVIterable =
        orderKV.apply(GroupByKey.<String, Integer>create());
    // Step 4: Convert to String
    PCollection<String> output =
        orderKVIterable.apply(
            ParDo.of(
    ...
    output.apply(
        TextIO.write()
            .to(Constants.BASE_PATH + "section4/output-group-by-key")
            .withNumShards(1)
